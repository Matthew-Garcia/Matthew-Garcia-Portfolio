      ...
      >
        {workData.map((project, index) => (
          ...
          >
            ...
            >
              <div className="bg-white w-6/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-1 px-2 flex items-center justify-between duration-500 group-hover:bottom-7">
                <div>
